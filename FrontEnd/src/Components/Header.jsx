...
const Header = () => {
  ...
  return (
    <section className='header bg-[#393E46] w-screen h-full md:w-fit md:min-h-screen flex justify-between items-center md:flex-col md:justify-between md:items-start md:rounded-tr-xl md:rounded-br-xl '>
        ...
        <nav className="profile flex items-center h-full md:w-full md:flex-col">
          ...
          <div className="user px-4 border-l-2 md:border-l-0 md:border-t-2 md:py-4 md:px-0 border-solid border-gray-500">
            ...
            <img src={User} className='rounded-full border-2 border-solid border-slate-400 w-12 h-12 object-cover' alt="" />
          </div>
        </nav>
    </section>
  )
